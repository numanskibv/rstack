    ...
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Platform')" class="grid">
                ...
                <flux:sidebar.item icon="squares-plus" :href="route('stacks.index')"
                    :current="request()->routeIs('stacks.*')" wire:navigate>
                    {{ __('Stacks') }}
                </flux:sidebar.item>
            </flux:sidebar.group>
            ...
            @if (auth()->user()?->is_admin)
                <flux:sidebar.group :heading="__('Admin')" class="grid">
                    ...
                    <flux:sidebar.item icon="at-symbol" :href="route('admin.domains')"
                        :current="request()->routeIs('admin.domains')" wire:navigate>
                        {{ __('Toegestane domeinen') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>
            @endif
        </flux:sidebar.nav>
