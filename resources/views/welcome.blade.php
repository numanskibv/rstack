    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Welcome to RStack 🚀</h1>
                <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">
                    Our homelab runs so we don't have to.<br>
                    Push code. Drink coffee. Pretend it was planned.
                </p>
                <ul class="flex flex-col mb-4 lg:mb-6 space-y-2 text-[#706f6c] dark:text-[#A1A09A]">
                    <li class="flex items-start gap-2">
                        <span class="mt-0.5 text-[#f53003]">▸</span>
                        <span>Git push → containers spin up automatically</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="mt-0.5 text-[#f53003]">▸</span>
                        <span>Zero downtime deployments, maximum uptime bragging rights</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="mt-0.5 text-[#f53003]">▸</span>
                        <span>Self-hosted. Because the cloud is just someone else's NUC</span>
                    </li>
                </ul>
            ...
            <div
                class="bg-zinc-100 dark:bg-zinc-900 relative lg:-ms-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-e-lg! aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden flex items-center justify-center">
                {{-- RStack Logo --}}
